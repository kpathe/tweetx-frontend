  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-white dark:bg-black font-sans">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 lg:px-12 py-12">
        <h1 className="text-5xl lg:text-6xl font-extrabold tracking-tight mb-12 dark:text-white">
          Happening now
        </h1>
        ...
        <div className="max-w-75 flex flex-col gap-4">
          ...
          <Link to="/signup">
            <Button
              bgColor="black"
              className="w-full bg-black  hover:bg-gray-900 text-white font-bold py-2.5 rounded-full border-none"
            >
              Create account
            </Button>
          </Link>
